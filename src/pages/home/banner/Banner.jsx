...
const Banner = () => {
    return (
        <div className='banner-container'>
            <div className='w-3/5 h-full flex flex-col justify-center space-y-6 p-8'>
                <h1 className='text-white text-5xl font-semibold  text-gradient'>We Deliver Your Goods With <br /> Passion & Love</h1>
